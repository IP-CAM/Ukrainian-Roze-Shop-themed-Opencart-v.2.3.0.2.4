...
$_['text_reviews']      = 'На підставі %s відгук(ів)';
$_['text_summary']      = 'Короткий опис';
$_['text_weight']       = 'Вага';
$_['text_dimension']    = '(Д x Ш x В)';
$_['text_compare']      = 'Порівняння товарів (%s)';
$_['text_success']      = 'Товар <a href="%s">%s</a> успішно доданий у <a href="%s">список порівняння</a>!';
$_['text_remove']       = 'Список товарів успішно оновлено!';
