...
$_['text_new_greeting']         = 'Дякуємо за інтерес до товарів %s. Ваше замовлення буде оброблено після підтвердження оплати.';
$_['text_new_received']         = 'Ви отримали замовлення.';
$_['text_new_link']             = 'Щоб переглянути замовлення, натисніть на посилання нижче:';
...
$_['text_new_download']         = 'Після підтвердження платежу ви можете натиснути на посилання нижче, щоб отримати доступ до товарів, що завантажуються:';
$_['text_new_comment']          = 'Коментарі до вашого замовлення:';
$_['text_new_footer']           = 'Будь ласка, дайте відповідь на цей лист, якщо у вас є які-небудь питання.';
$_['text_update_subject']       = '%s - Ваше замовлення #%s було оновлено';
...
$_['text_update_link']          = 'Щоб переглянути замовлення, натисніть на посилання нижче:';
$_['text_update_footer']        = 'Будь ласка, дайте відповідь на цей лист, якщо у вас є які-небудь питання.';
