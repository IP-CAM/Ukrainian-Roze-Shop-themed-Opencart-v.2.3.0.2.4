<?php
// Heading
$_['heading_title']         = 'Картки Sagepay Direct';

// Text
$_['text_empty']		    = 'У вас немає збережених карток';
$_['text_account']          = 'Обліковий запис';
$_['text_card']			    = 'Пряме керування картками SagePay';
$_['text_fail_card']	    = 'Під час видалення картки SagePay виникла проблема. Зверніться по допомогу до адміністратора магазину.';
...
$_['entry_cc_choice']       = 'Виберіть наявну картку';
