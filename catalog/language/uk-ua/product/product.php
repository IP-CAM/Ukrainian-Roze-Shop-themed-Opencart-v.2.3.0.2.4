...
$_['text_trial_description']                  = '%s кожен %d %sй для %d оплат(и),';
$_['text_payment_description']                = '%s кожен %d %s(-и) з %d платежів(-ів)';
...
$_['error_text']                              = 'Текст відкликання має бути від 25 до 1000 символів!';
